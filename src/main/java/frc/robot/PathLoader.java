...
public class PathLoader {
    ...
    public static PPSwerveControllerCommand loadPath(String name, DriveSubsystem driveSub) {
        Consumer<SwerveModuleState[]> consumer = a -> driveSub.setAutonSwerveModuleStates(a);
